...
describe('newGame shape', () => {
  it('bootstraps a fresh settlement with the documented starting values', () => {
    ...
    expect(s.run.caps).toEqual({ wood: 200, food: 200, stone: 200, iron: 200, coal: 200, steel: 200, tools: 200, engines: 200, furniture: 200, parchment: 200, books: 200, compendiums: 200, furs: 200, manaCrystals: 200 });
  ...
  it('every resource id is present in a fresh ledger', () => {
    ...
    expect(freshCaps()).toEqual({ wood: 200, food: 200, stone: 200, iron: 200, coal: 200, steel: 200, tools: 200, engines: 200, furniture: 200, parchment: 200, books: 200, compendiums: 200, furs: 200, manaCrystals: 200 });
  });
});
...
describe('save round-trip', () => {
  ...
  it('migrates a v1 save (no culture) up to current, backfilling culture → 0', () => {
    ...
    expect(res.state!.version).toBe(10);
    ...
    const v6: any = {
      ...
      state: {
        ...
        run: {
          ...
          caps: { wood: 200, food: 200, stone: 200, iron: 200, coal: 200, steel: 200, tools: 200, engines: 200, furniture: 200, parchment: 200, books: 200, compendiums: 200, furs: 200, manaCrystals: 200 },
          population: { total: 0, jobs: {} },
          popCap: 0,
    ...
    const v7: any = {
      ...
      state: {
        ...
        run: {
          ...
          caps: { wood: 200, food: 200, stone: 200, iron: 200, coal: 200, steel: 200, furs: 200, manaCrystals: 200 }, // no tools/engines/furniture
          population: { total: 0, jobs: {} },
          popCap: 0,
          buildings: {},
          active: {},
    ...
    const v8: any = {
      ...
      state: {
        ...
        run: {
          ...
          caps: { wood: 200, food: 200, stone: 200, iron: 200, coal: 200, steel: 200, tools: 200, engines: 200, furniture: 200, furs: 200, manaCrystals: 200 }, // no knowledge-good caps
          population: { total: 0, jobs: {} },
          popCap: 0,
          buildings: {},
          active: {},
...
describe('normalize backfill', () => {
  it('backfills absent containers so read models never see undefined', () => {
    ...
    expect(partial.run.caps).toEqual({ wood: 200, food: 200, stone: 200, iron: 200, coal: 200, steel: 200, tools: 200, engines: 200, furniture: 200, parchment: 200, books: 200, compendiums: 200, furs: 200, manaCrystals: 200 });
