...
const FIRST_BUILD_QUIPS: Partial<Record<BuildingId, string>> = {
  ...
  'engine-works': 'The first engine turns over. No two citizens agree on what the noise is.',
  ...
  'arcane-font': 'The font wells up with mana. Someone will have to sit with it.',
  'enchanted-grove': 'The grove fruits in the wrong month, cheerfully, and will not be reasoned with.',
  'quickwood-stand': 'A felled quickwood is back by morning. The woodcutters stop counting stumps.',
  'stone-garden': 'The stones are bigger than they were. Everyone agrees not to mention it.',
  alembic: 'The alembic ticks over. By the third day it has proved something nobody asked about.',
